...
from unicorn.arm64_const import (
    ...
    UC_ARM64_REG_D16, UC_ARM64_REG_D17, UC_ARM64_REG_D18, UC_ARM64_REG_D19,
    UC_ARM64_REG_D20, UC_ARM64_REG_D21, UC_ARM64_REG_D22, UC_ARM64_REG_D23,
    UC_ARM64_REG_D24, UC_ARM64_REG_D25, UC_ARM64_REG_D26, UC_ARM64_REG_D27,
    UC_ARM64_REG_D28, UC_ARM64_REG_D29, UC_ARM64_REG_D30, UC_ARM64_REG_D31,
    UC_ARM64_REG_FPCR, UC_ARM64_REG_FPSR,
)
...
class ArchConfig:
    ...
    # FP/SIMD registers — separate from GPR register_map.
    # Maps name -> (uc_const, kind) where kind is "vec", "x87", or "scalar".
    fp_register_map: dict[str, tuple[int, str]] = field(default_factory=dict)
...
# x86_32 FP/SIMD registers.
_X86_32_FP_MAP: Final[dict[str, tuple[int, str]]] = {
    "fp0": (UC_X86_REG_FP0, "x87"),
    "fp1": (UC_X86_REG_FP1, "x87"),
    "fp2": (UC_X86_REG_FP2, "x87"),
    "fp3": (UC_X86_REG_FP3, "x87"),
    "fp4": (UC_X86_REG_FP4, "x87"),
    "fp5": (UC_X86_REG_FP5, "x87"),
    "fp6": (UC_X86_REG_FP6, "x87"),
    "fp7": (UC_X86_REG_FP7, "x87"),
    "xmm0": (UC_X86_REG_XMM0, "vec"),
    "xmm1": (UC_X86_REG_XMM1, "vec"),
    "xmm2": (UC_X86_REG_XMM2, "vec"),
    "xmm3": (UC_X86_REG_XMM3, "vec"),
    "xmm4": (UC_X86_REG_XMM4, "vec"),
    "xmm5": (UC_X86_REG_XMM5, "vec"),
    "xmm6": (UC_X86_REG_XMM6, "vec"),
    "xmm7": (UC_X86_REG_XMM7, "vec"),
    "fpcw": (UC_X86_REG_FPCW, "scalar"),
    "fpsw": (UC_X86_REG_FPSW, "scalar"),
    "fptag": (UC_X86_REG_FPTAG, "scalar"),
    "mxcsr": (UC_X86_REG_MXCSR, "scalar"),
}

# x86_64 FP/SIMD registers (superset of x86_32).
_X86_64_FP_MAP: Final[dict[str, tuple[int, str]]] = {
    "fp0": (UC_X86_REG_FP0, "x87"),
    "fp1": (UC_X86_REG_FP1, "x87"),
    "fp2": (UC_X86_REG_FP2, "x87"),
    "fp3": (UC_X86_REG_FP3, "x87"),
    ...
    "xmm6": (UC_X86_REG_XMM6, "vec"),
    "xmm7": (UC_X86_REG_XMM7, "vec"),
    "xmm8": (UC_X86_REG_XMM8, "vec"),
    "xmm9": (UC_X86_REG_XMM9, "vec"),
    "xmm10": (UC_X86_REG_XMM10, "vec"),
    "xmm11": (UC_X86_REG_XMM11, "vec"),
    "xmm12": (UC_X86_REG_XMM12, "vec"),
    "xmm13": (UC_X86_REG_XMM13, "vec"),
    "xmm14": (UC_X86_REG_XMM14, "vec"),
    "xmm15": (UC_X86_REG_XMM15, "vec"),
    "ymm0": (UC_X86_REG_YMM0, "vec"),
    "ymm1": (UC_X86_REG_YMM1, "vec"),
    "ymm2": (UC_X86_REG_YMM2, "vec"),
    "ymm3": (UC_X86_REG_YMM3, "vec"),
    "ymm4": (UC_X86_REG_YMM4, "vec"),
    "ymm5": (UC_X86_REG_YMM5, "vec"),
    "ymm6": (UC_X86_REG_YMM6, "vec"),
    "ymm7": (UC_X86_REG_YMM7, "vec"),
    "ymm8": (UC_X86_REG_YMM8, "vec"),
    "ymm9": (UC_X86_REG_YMM9, "vec"),
    "ymm10": (UC_X86_REG_YMM10, "vec"),
    "ymm11": (UC_X86_REG_YMM11, "vec"),
    "ymm12": (UC_X86_REG_YMM12, "vec"),
    "ymm13": (UC_X86_REG_YMM13, "vec"),
    "ymm14": (UC_X86_REG_YMM14, "vec"),
    "ymm15": (UC_X86_REG_YMM15, "vec"),
    "fpcw": (UC_X86_REG_FPCW, "scalar"),
    "fpsw": (UC_X86_REG_FPSW, "scalar"),
    "fptag": (UC_X86_REG_FPTAG, "scalar"),
    "mxcsr": (UC_X86_REG_MXCSR, "scalar"),
...
_ARM64_FP_MAP: Final[dict[str, tuple[int, str]]] = {
    "q0": (UC_ARM64_REG_Q0, "vec"),
    "q1": (UC_ARM64_REG_Q1, "vec"),
    "q2": (UC_ARM64_REG_Q2, "vec"),
    "q3": (UC_ARM64_REG_Q3, "vec"),
    "q4": (UC_ARM64_REG_Q4, "vec"),
    "q5": (UC_ARM64_REG_Q5, "vec"),
    "q6": (UC_ARM64_REG_Q6, "vec"),
    "q7": (UC_ARM64_REG_Q7, "vec"),
    "q8": (UC_ARM64_REG_Q8, "vec"),
    "q9": (UC_ARM64_REG_Q9, "vec"),
    "q10": (UC_ARM64_REG_Q10, "vec"),
    "q11": (UC_ARM64_REG_Q11, "vec"),
    "q12": (UC_ARM64_REG_Q12, "vec"),
    "q13": (UC_ARM64_REG_Q13, "vec"),
    "q14": (UC_ARM64_REG_Q14, "vec"),
    "q15": (UC_ARM64_REG_Q15, "vec"),
    "q16": (UC_ARM64_REG_Q16, "vec"),
    "q17": (UC_ARM64_REG_Q17, "vec"),
    "q18": (UC_ARM64_REG_Q18, "vec"),
    "q19": (UC_ARM64_REG_Q19, "vec"),
    "q20": (UC_ARM64_REG_Q20, "vec"),
    "q21": (UC_ARM64_REG_Q21, "vec"),
    "q22": (UC_ARM64_REG_Q22, "vec"),
    "q23": (UC_ARM64_REG_Q23, "vec"),
    "q24": (UC_ARM64_REG_Q24, "vec"),
    "q25": (UC_ARM64_REG_Q25, "vec"),
    "q26": (UC_ARM64_REG_Q26, "vec"),
    "q27": (UC_ARM64_REG_Q27, "vec"),
    "q28": (UC_ARM64_REG_Q28, "vec"),
    "q29": (UC_ARM64_REG_Q29, "vec"),
    "q30": (UC_ARM64_REG_Q30, "vec"),
    "q31": (UC_ARM64_REG_Q31, "vec"),
    "d0": (UC_ARM64_REG_D0, "vec"),
    "d1": (UC_ARM64_REG_D1, "vec"),
    "d2": (UC_ARM64_REG_D2, "vec"),
    "d3": (UC_ARM64_REG_D3, "vec"),
    "d4": (UC_ARM64_REG_D4, "vec"),
    "d5": (UC_ARM64_REG_D5, "vec"),
    "d6": (UC_ARM64_REG_D6, "vec"),
    "d7": (UC_ARM64_REG_D7, "vec"),
    "d8": (UC_ARM64_REG_D8, "vec"),
    "d9": (UC_ARM64_REG_D9, "vec"),
    "d10": (UC_ARM64_REG_D10, "vec"),
    "d11": (UC_ARM64_REG_D11, "vec"),
    "d12": (UC_ARM64_REG_D12, "vec"),
    "d13": (UC_ARM64_REG_D13, "vec"),
    "d14": (UC_ARM64_REG_D14, "vec"),
    "d15": (UC_ARM64_REG_D15, "vec"),
    "d16": (UC_ARM64_REG_D16, "vec"),
    "d17": (UC_ARM64_REG_D17, "vec"),
    "d18": (UC_ARM64_REG_D18, "vec"),
    "d19": (UC_ARM64_REG_D19, "vec"),
    "d20": (UC_ARM64_REG_D20, "vec"),
    "d21": (UC_ARM64_REG_D21, "vec"),
    "d22": (UC_ARM64_REG_D22, "vec"),
    "d23": (UC_ARM64_REG_D23, "vec"),
    "d24": (UC_ARM64_REG_D24, "vec"),
    "d25": (UC_ARM64_REG_D25, "vec"),
    "d26": (UC_ARM64_REG_D26, "vec"),
    "d27": (UC_ARM64_REG_D27, "vec"),
    "d28": (UC_ARM64_REG_D28, "vec"),
    "d29": (UC_ARM64_REG_D29, "vec"),
    "d30": (UC_ARM64_REG_D30, "vec"),
    "d31": (UC_ARM64_REG_D31, "vec"),
    "fpcr": (UC_ARM64_REG_FPCR, "scalar"),
    "fpsr": (UC_ARM64_REG_FPSR, "scalar"),
}

# ARM32 FP/SIMD registers.
_ARM32_FP_MAP: Final[dict[str, tuple[int, str]]] = {
    "d0": (UC_ARM_REG_D0, "vec"),
    "d1": (UC_ARM_REG_D1, "vec"),
    "d2": (UC_ARM_REG_D2, "vec"),
    "d3": (UC_ARM_REG_D3, "vec"),
    "d4": (UC_ARM_REG_D4, "vec"),
    "d5": (UC_ARM_REG_D5, "vec"),
    "d6": (UC_ARM_REG_D6, "vec"),
    "d7": (UC_ARM_REG_D7, "vec"),
    "d8": (UC_ARM_REG_D8, "vec"),
    "d9": (UC_ARM_REG_D9, "vec"),
    "d10": (UC_ARM_REG_D10, "vec"),
    "d11": (UC_ARM_REG_D11, "vec"),
    "d12": (UC_ARM_REG_D12, "vec"),
    "d13": (UC_ARM_REG_D13, "vec"),
    "d14": (UC_ARM_REG_D14, "vec"),
    "d15": (UC_ARM_REG_D15, "vec"),
    "d16": (UC_ARM_REG_D16, "vec"),
    "d17": (UC_ARM_REG_D17, "vec"),
    "d18": (UC_ARM_REG_D18, "vec"),
    "d19": (UC_ARM_REG_D19, "vec"),
    "d20": (UC_ARM_REG_D20, "vec"),
    "d21": (UC_ARM_REG_D21, "vec"),
    "d22": (UC_ARM_REG_D22, "vec"),
    "d23": (UC_ARM_REG_D23, "vec"),
    "d24": (UC_ARM_REG_D24, "vec"),
    "d25": (UC_ARM_REG_D25, "vec"),
    "d26": (UC_ARM_REG_D26, "vec"),
    "d27": (UC_ARM_REG_D27, "vec"),
    "d28": (UC_ARM_REG_D28, "vec"),
    "d29": (UC_ARM_REG_D29, "vec"),
    "d30": (UC_ARM_REG_D30, "vec"),
    "d31": (UC_ARM_REG_D31, "vec"),
    "fpscr": (UC_ARM_REG_FPSCR, "scalar"),
}
...
ARCHITECTURES: Final[dict[str, ArchConfig]] = {
    "x86_32": ArchConfig(
        ...
        ks_arch=KS_ARCH_X86,
        ks_mode=KS_MODE_32,
        fp_register_map=_X86_32_FP_MAP,
    ),
    "x86_64": ArchConfig(
        name="x86_64",
        uc_arch=UC_ARCH_X86,
        ...
        ks_arch=KS_ARCH_X86,
        ks_mode=KS_MODE_64,
        fp_register_map=_X86_64_FP_MAP,
    ),
    "arm": ArchConfig(
        name="arm",
        uc_arch=UC_ARCH_ARM,
